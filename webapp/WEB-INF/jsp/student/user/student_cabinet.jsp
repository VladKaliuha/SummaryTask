        ...
        <c:choose>
            ...
            <c:when test="${userRole.name == 'admin' }">
                <table id="test" class="table_test">
                    <thead>
                    <tr>
                        <th><a href="controller?command=showUserResults"><fmt:message
                                key="user_info.link.user_result"/></a></th>
                        <th><a href="controller?command=showAllUsers"><fmt:message key="user_info.link.user"/></a></th>
                        <th><a href="controller?command=forwardTo&command_name=find_user"><fmt:message
                                key="user_info.link.find_user"/></a></th>
                    </tr>
                    </thead>
                </table>
            </c:when>
