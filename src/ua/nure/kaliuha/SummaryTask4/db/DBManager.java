...
public final class DBManager {
    ...
    private static final String SQL_UPDATE_USER_ROLE = "UPDATE user SET role_id=? WHERE id=?";
    ...
    private static final String SQL_UPDATE_SUBJECT_NAME = "UPDATE subject SET name=? WHERE id=?";
    ...
    private static final String SQL_FIND_TRUE_ANSWER_BY_QUESTION_ID = "SELECT * FROM answer WHERE question_id=? AND is_right=?";
